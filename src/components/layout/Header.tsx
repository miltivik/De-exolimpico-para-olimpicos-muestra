      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center py-3 md:py-4">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="https://com-partidauruguay.weebly.com/s" target="_blank" rel="noopener noreferrer" className="bg-yellow-500 text-white font-medium px-5 py-2.5 rounded-full hover:bg-yellow-600 transition-colors">
              Sitio Oficial
            </Link>
          </nav>
